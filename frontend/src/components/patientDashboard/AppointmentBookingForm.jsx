...
const AppointmentBookingForm = ({ isVisible, onClose, prefilledDate = "", onSubmitSuccess = () => {} }) => {
        ...
        try {
          ...
          if (response.data.success) {
            ...
            setFormData((prev) => ({
              ...
              appointment_date: prefilledDate || "", // Use prefilled date if available
            }))
          }
        } catch (error) {
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              <label className="checkbox-label">
                <input type="checkbox" name="hasVisited" checked={formData.hasVisited} onChange={handleInputChange} />
